...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="aboutList"  pageSize="10" checkbox="true" pagination="true" fitColumns="false" 
         queryMode="group" title="案例管理" actionUrl="webCc3Controller.do?aboutdatagrid" idField="id" fit="true">
   ...
   <t:dgCol title="状态"  field="status" width="100" query="true"></t:dgCol>
    <t:dgCol title="创建人"  field="createBy" width="100" query="true"></t:dgCol>
   <t:dgCol title="存储时间"  field="createTime" formatter="yyyy-MM-dd hh:mm:ss" width="150"></t:dgCol>
   
   <t:dgToolBar title="信息录入" icon="icon-add" url="webCc3Controller.do?about_goAdd" funname="add" width="770" height="500"></t:dgToolBar>
