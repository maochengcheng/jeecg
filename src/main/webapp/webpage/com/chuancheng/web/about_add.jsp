...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="webCc3Controller.do?about_doAdd" >
		<input id="id" name="id" type="true" value="${aboutPage.id }"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
					...
					<td class="value">
					     	 ...
					     	 <input id="dataType" value="" name="dataType" type="text" style="width: 150px" class="inputxt" />
