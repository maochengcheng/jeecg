...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list" fitColumns="true" actionUrl="base01Controller.do?departgrid" treegrid="true" idField="departid" pagination="false">
            ...
            <t:dgDelOpt url="base01Controller.do?del&id={id}" title="common.delete" urlclass="ace_button"  urlfont="fa-trash-o" urlStyle="background-color:#ec4758;"></t:dgDelOpt>
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                ...
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','base01Controller.do?update','departList','680px','450px')"><t:mutiLang langKey="common.edit.param" langArg="common.department"/></a>
...
<!--
    ...
    function addOrg() {
        ...
        var url = "base01Controller.do?add&id=" + id;
    ...
    function queryUsersByDepart(departid){
        ...
        $('#userListpanel').panel("refresh", "base01Controller.do?userList&departid=" + departid);
    }
    /**
     * 为 组织机构 设置 角色
    ...
    //导入
    function ImportXls() {
        openuploadwin('Excel导入', 'base01Controller.do?upload', "departList");
    }
    //导入
    function ImportDepartXls() {
        openuploadwin('Excel导入', 'base01Controller.do?uploadDepart', "departList");
    }

    //导出
    function ExportXls() {
        JeecgExcelExport("base01Controller.do?exportXls","departList");
    }

    //模板下载
    function ExportXlsByT() {
//        JeecgExcelExport("base01Controller.do?exportXlsByT","departList");
