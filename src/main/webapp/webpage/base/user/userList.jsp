...
<t:datagrid name="userList" title="common.operation" actionUrl="base02Controller.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="base02Controller.do?addorupdate" funname="add" height="420"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="base02Controller.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.password.reset" icon="icon-edit" url="base02Controller.do?changepasswordforuser" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.lock.user" icon="icon-edit" url="base02Controller.do?lock&lockvalue=0" funname="lockObj"></t:dgToolBar>
	<t:dgToolBar title="common.unlock.user" icon="icon-edit" url="base02Controller.do?lock&lockvalue=1" funname="unlockObj"></t:dgToolBar>
...
function deleteDialog(id){
	var url = "base02Controller.do?deleteDialog&id=" + id
...
<script type="text/javascript">
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'base02Controller.do?upload', "userList");
	}

	//导出
	function ExportXls() {
		JeecgExcelExport("base02Controller.do?exportXls", "userList");
	}

	//模板下载
	function ExportXlsByT() {
		JeecgExcelExport("base02Controller.do?exportXlsByT", "userList");
	}
</script>